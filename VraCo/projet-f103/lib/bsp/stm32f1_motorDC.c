...
void MOTOR_init(void)
{
	...
	PWM_run(TIMER1_ID, TIM_CHANNEL_1,TRUE,PWM_PERIOD,100, FALSE);	//1.CH1N
	PWM_run(TIMER1_ID, TIM_CHANNEL_2,TRUE,PWM_PERIOD,100, FALSE);	//1.CH2N
	PWM_run(TIMER1_ID, TIM_CHANNEL_3,TRUE,PWM_PERIOD,100, FALSE);	//1.CH3N
